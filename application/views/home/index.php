    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container section text-center txt-150">
            <h1 class="display-4 txt-up text-white">Create your vote <span
                    class="font-weight-bold txt-pink">easily</span><br>and <span
                    class="font-weight-bold txt-pink">better</span> with us</h1>
            <p class="lead"></p>
